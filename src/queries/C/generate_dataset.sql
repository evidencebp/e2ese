...
drop table if exists general.june_2021_c_file_content;
...
drop table if exists general.june_2021_c_file_content_train;

create table
general.june_2021_c_file_content_train
as
select
id
, cnt.repo_name
...
from
general.june_2021_c_file_content as cnt
where
general.bq_repo_split(cnt.repo_name) = 'Train'
;

drop table if exists general.june_2021_c_file_content_test;

create table
general.june_2021_c_file_content_test
as
select
id
, cnt.repo_name
...
drop table if exists general.june_2021_c_file_content_validation;

create table
general.june_2021_c_file_content_validation
as
select
id
, cnt.repo_name
...
drop table if exists general.june_2020_c_file_properties;

create table
general.june_2020_c_file_properties
as
select
id
, fp.*
