drop table if exists general.august_2021_go_file_content;

create table
general.august_2021_go_file_content
as
select
id
, cnt.repo_name
...
drop table if exists general.august_2021_go_file_content_train;

create table
general.august_2021_go_file_content_train
as
select
id
, cnt.repo_name
...
from
general.august_2021_go_file_content as cnt
where
general.bq_repo_split(cnt.repo_name) = 'Train'
;

drop table if exists general.august_2021_go_file_content_test;

create table
general.august_2021_go_file_content_test
as
select
id
, cnt.repo_name
...
drop table if exists general.august_2021_go_file_content_validation;

create table
general.august_2021_go_file_content_validation
as
select
id
, cnt.repo_name
...
drop table if exists general.august_2020_go_file_properties;

create table
general.august_2020_go_file_properties
as
select
id
, fp.*
