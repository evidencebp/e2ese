drop table if exists general.june_2021_go_file_content;

create table
general.june_2021_go_file_content
as
select
id
, cnt.repo_name
...
drop table if exists general.june_2021_go_file_content_train;

create table
general.june_2021_go_file_content_train
as
select
id
, cnt.repo_name
...
drop table if exists general.june_2021_go_file_content_test;

create table
general.june_2021_go_file_content_test
as
select
id
, cnt.repo_name
...
drop table if exists general.june_2021_go_file_content_validation;

create table
general.june_2021_go_file_content_validation
as
select
id
, cnt.repo_name
